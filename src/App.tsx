...
const App: React.FC = () => {
  ...
  // Función para crear proceso desde template
  const crearProcesoDesdeTemplate = (template: any) => {
    const nuevoProceso = {
      id: Date.now().toString(),
      ...
      progreso: 0,
      documentos: template.documentosRequeridos?.map((doc: any) => ({
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20">
              <div className="flex flex-wrap gap-3 justify-center">
                <button
                  ...
                  className="px-4 py-2 rounded-lg transition-colors bg-gray-200 text-gray-700 hover:bg-gray-300"
                >
                  Clientes
                </button>
                <button
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <Sidebar
        ...
        notificationsCount={notificacionesNoLeidas}
        onNotificationsClick={handleNotificationsClick}
        onHomeClick={handleHomeClick}
        showHomeButton={currentView !== 'dashboard'}
      />
