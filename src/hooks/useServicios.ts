...
export const useServicios = () => {
  ...
  useEffect(() => {
    ...
    const notificacionesIniciales: NotificacionPrecio[] = [
      {
        id: '1',
        tipo: 'precio_faltante',
        procedimiento: 'Certificación de Conformidad ex post',
        organismo: 'Dirección Nacional de Reglamentos Técnicos',
        mensaje: 'Este procedimiento no tiene precio asignado. Se requiere cotización.',
        fecha: new Date(),
        leida: false
      }
    ];
